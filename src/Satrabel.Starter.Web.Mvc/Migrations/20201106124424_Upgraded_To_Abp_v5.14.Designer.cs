...
namespace Satrabel.OpenApp.Migrations
{
    ...
    [Migration("20201106124424_Upgraded_To_Abp_v5.14")]
    partial class Upgraded_To_Abp_v514
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Satrabel.OpenApp.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Satrabel.OpenApp.Authorization.Users.User", null)
                        .WithMany("Claims")
