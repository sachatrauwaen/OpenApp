...
namespace Satrabel.OpenApp.Migrations
{
    ...
    [Migration("20180829073724_PageParent")]
    partial class PageParent
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Satrabel.Starter.Web.Domain.Cms.Module", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Satrabel.Starter.Web.Domain.Cms.ModuleTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Satrabel.Starter.Web.Domain.Cms.Page", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Satrabel.Starter.Web.Domain.Cms.PageModule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("CmsPageModule");
                });

            modelBuilder.Entity("Satrabel.Starter.Web.Domain.Cms.PageTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Satrabel.Starter.Web.Domain.Cms.ModuleTranslation", b =>
                {
                    b.HasOne("Satrabel.Starter.Web.Domain.Cms.Module", "Core")
            ...
            modelBuilder.Entity("Satrabel.Starter.Web.Domain.Cms.Page", b =>
                {
                    b.HasOne("Satrabel.Starter.Web.Domain.Cms.Page", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
                });
            ...
            modelBuilder.Entity("Satrabel.Starter.Web.Domain.Cms.PageModule", b =>
                {
                    b.HasOne("Satrabel.Starter.Web.Domain.Cms.Module", "Module")
                        .WithMany("PageModules")
                        .HasForeignKey("ModuleId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Satrabel.Starter.Web.Domain.Cms.Page", "Page")
                        .WithMany("PageModules")
            ...
            modelBuilder.Entity("Satrabel.Starter.Web.Domain.Cms.PageTranslation", b =>
                {
                    b.HasOne("Satrabel.Starter.Web.Domain.Cms.Page", "Core")
                        .WithMany("Translations")
                        .HasForeignKey("CoreId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
